...
<body>
    ...
    <form  name="formulario" action="query_lev1.php" method="POST" enctype="multipart/form-data" style="width:90%;margin:0 auto;" name="formulario" onsubmit="document.forms['formulario']['enviar'].disabled=true;" >
        ...
        <fieldset>
            ...
            <legend class="text-center header text-danger">Imagenes de la fachada</legend>
                ...
                <input type="file" name="fachada1" id="fachada1" >
                <br><br>
                <label>Fotografia del Lateral Derecho de la casa</label>
                <input type="file" name="fachada2" id="fachada2" >
                <br><br>
                <label>Fotografia del Lateral Izquierdo de la casa</label>
                <input type="file" name="fachada3" id="fachada3">
                <br><br>
